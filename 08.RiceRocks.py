...
#helper function to draw group of sprites
...
#helper function for ship-rocks collisions
...
def rock_spawner():
    ...
    #increase the rocks' velocity as the game progresses
    if score < 20:
        rock_vel[0] *= 1.0
        rock_vel[1] *= 1.0
    elif score < 50:
    ...
    if dist(rock_pos, my_ship.get_position()) > 150 and len(rock_group) < 12:
